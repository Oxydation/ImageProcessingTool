 ...
 */
public class Median extends AbstractPicture implements PropertyChangeListener {
    ...
    public void process() {
        if (getOriginal() != null) {
            ...
            Catalano.Imaging.Filters.Median closing = new Catalano.Imaging.Filters.Median(getRadius());
